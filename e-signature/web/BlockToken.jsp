...
return false;">Apply For Soft Token</a></li> --%>
        ...
        <center>            
        <h1>Block Soft Token</h1>
        
        
        
        
        <form method="post" action="BlockToken">
            <table border="0">                
                <tr>
                    <td>Click the Button to Block Soft Token of ${fname} </td>                    
                </tr>
                <br><br>
                <tr>
                    <td> </td>
                ...
                <tr>
                    <td align="center"><input type="submit" value="Block Token"/></td>
                </tr>
